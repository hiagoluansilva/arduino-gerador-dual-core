...
void setup() {
  Serial.begin(115200); 
  timer1 = timerBegin(0, 992, true);
  timerAttachInterrupt(timer1, &seno, true);
  timerAlarmWrite(timer1, 12, true); 
  timerAlarmEnable(timer1);
/*
  timer2 = timerBegin(1, 80, true);
  timerAttachInterrupt(timer2, &triangular, true);
  timerAlarmWrite(timer2, 100, true); 
...
void loop2( void * z)
{
  while(1)
  {
    dacWrite(26, WaveFormTable[1][y]); //25 ou 26
    y++;
...
void loop(){}
  ...
  void seno()
  {
    dacWrite(25, WaveFormTable[0][i]); //25 ou 26
    i++;
